...
function getCustId() {
    var hiddenElem = document.getElementById('CustomerId');
    var firstName = document.getElementById('Customer_Firstname').getAttribute('value');
...
function queryCustomer(customer) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch(this.CustomerUri + "?name=" + customer)
                        .then(function (response) { return response.json(); })];
                case 1:
                    awaitFetch = _a.sent();
                    return [2 /*return*/, awaitFetch];
            }
        });
    });
}
